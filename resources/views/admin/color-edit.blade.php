...
<div class="main-content-inner">
    <div class="main-content-wrap">
        ...
        <div class="wg-box">
            <form class="form-new-product form-style-1" action="{{route('admin.color.update', ['id' => $color->id])}}" method="POST">
                @csrf
                @method('POST')
                <fieldset class="name">
                    ...
                    <input class="flex-grow" type="text" placeholder="Color name" name="name"
                        tabindex="0" value="{{$color->name}}" aria-required="true" required="">
                </fieldset>
                ...
                <fieldset class="name">
                    ...
                    <input class="flex-grow" type="text" placeholder="Color Code (e.g., #FF0000)" name="code"
                        tabindex="0" value="{{$color->code}}" aria-required="true" required="">
                </fieldset>
